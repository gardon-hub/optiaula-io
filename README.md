...
| `npm run test` | 566 pruebas unitarias del motor matemático y de los datos |
...
corre las 566 pruebas del motor **antes** de publicar. Si una prueba falla, no se publica: queda en
...
```
566 pruebas unitarias    motor matemático, biblioteca de datos, retroalimentación y generador
